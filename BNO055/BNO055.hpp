/*
 *	UVR BNO055 MBED Library
 *
 *	@author	 Andres Martinez
 *	@version 0.9a
 *	@date	 8-May-2017
 *
 *	MBED library for Bosch BNO055 sensor fusion board. Adapted from
 * 	mbed library program written by Kenji Arai:
 *  https://developer.mbed.org/users/kenjiArai/code/BNO055_fusion/
 *
 *	Written for UVic Rocketry
 *
 *	To-do:
 *	- Finalize data structures pass to/from sampling functions
 *	- Finalize calibration routines 
 */
...
public:
    ...
    /** Configure data pin (with other devices on I2C line)
      ...
      */
    BNO055(I2C* _i2c_p, PinName interrupt, uint8_t addr = BNO055_G_CHIP_ADDR, uint8_t mode = MODE_NDOF);
